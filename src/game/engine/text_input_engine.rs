use crate::game::{renderer::Renderer, Game};
...
pub struct TextInputEngine<'a, R: Renderer> {
    renderer: R,
    game: &'a mut Game,
}

impl<'a, R: Renderer> TextInputEngine<'a, R> {
...
impl<'a, R: Renderer> Engine for TextInputEngine<'a, R> {
